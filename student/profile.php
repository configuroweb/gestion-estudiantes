...
if (strlen($_SESSION['sturecmsaid'] == 0)) {
  ...
  if (isset($_POST['submit'])) {
    ...
    echo '<script>alert("Has actualizado exitosamente la información de tu perfil")</script>';
    ...
    <div class="main-panel">
      <div class="content-wrapper">
        <div class="page-header">
          <h3 class="page-title"> Perfil de Estudiante </h3>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
              <li class="breadcrumb-item active" aria-current="page">Perfil de Estudiante</li>
            </ol>
          </nav>
        </div>
        <div class="row">
          ...
          <div class="col-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title" style="text-align: center;">Perfil de Estudiante</h4>
                  ...
                  if ($query->rowCount() > 0) {
                    foreach ($results as $row) {               ?>
                      <div class="form-group">
                        ...
                        <input type="text" name="adminname" value="<?php echo $row->StudentName; ?>" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="email" name="email" value="<?php echo $row->UserName; ?>" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
